...
annotation<-  read.csv("metadata.csv", header = T, sep = ",")
annotation$Status <- annotation$Status  %>% str_replace_all("additional_U-CLL", "U-CLL")
annotation$Status <- annotation$Status  %>% str_replace_all("tris12_U-CLL", "U-CLL")
